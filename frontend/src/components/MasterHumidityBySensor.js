...
import HumidityBySensorChart from './HumidityBySensorChart';


class MasterHumidityBySensor extends React.Component {
    constructor(props) {
        super(props)
    ...
    componentDidUpdate() {
        // If state changes elsewhere, we call this method to make sure we're still highlighting the appropriate "select room" button.
    ...
    render() {
        ...
        return (
            <div>
                ...
                <HumidityBySensorChart ids={ids} />
            </div>
        )
    }
}

export default MasterHumidityBySensor;